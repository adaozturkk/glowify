    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            catch (Exception ex)
            {
                ...
                ApplicationUser user = _db.ApplicationUsers.FirstOrDefault(u => u.Email == "admin@lowify.com");
                ...
                var products = new List<Product>
                {
                    ...
                    new Product
                    {
                        ...
                        ListPrice = 239.90,
                        Price = 189.90,
                        ImageUrl = @"/images/products/toner1.jpg",
                        TargetSkinType = SkinType.Dry,
                    ...
                    new Product
                    {
                        ...
                        ListPrice = 259.90,
                        Price = 209.90,
                        ImageUrl = @"/images/products/toner2.jpg",
                        TargetSkinType = SkinType.Oily,
                        Category = CategoryType.Toner,
